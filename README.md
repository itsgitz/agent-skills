...
| [git-ticket](./git-ticket/) | Generate + create a GitHub/GitLab issue/PR/MR from your context, with house title-format support and markdown fallback | `npx skills add itsgitz/agent-skills/git-ticket` |
