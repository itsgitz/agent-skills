...
| [git-ticket](./git-ticket/) | Generate + create a GitHub/GitLab issue/PR/MR from your context, with house title-format support and markdown fallback; also close tickets and move GitHub Projects v2 cards between Status columns | `npx skills add itsgitz/agent-skills/git-ticket` |
